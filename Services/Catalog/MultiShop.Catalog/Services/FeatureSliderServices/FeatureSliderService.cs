...
namespace MultiShop.Catalog.Services.FeatureSliderServices
{
    public class FeatureSliderService : IFeatureSliderService
    {
        ...
        public FeatureSliderService(IDatabaseSettings _databaseSettings, IMapper mapper)
        {
            ...
            _featureSliderCollection = database.GetCollection<FeatureSlider>(_databaseSettings.FeatureSliderCollecitonName);//tablo
        ...
        public Task FeatureSliderChangesStatusToFalse(string id)
        {
            throw new NotImplementedException();
        }

        public Task FeatureSliderChangesStatusToTrue(string id)
        {
            throw new NotImplementedException();
        }
